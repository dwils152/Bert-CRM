...
from BertForTokenClassification import BertForTokenClassification as BertTok
from BertCRFForTokenClassification import BertCRFForTokenClassification as BertTokCRF
...
def main(args):
    ...
    dataloader = torch.utils.data.DataLoader(
        dataset, batch_size=128, shuffle=False, num_workers=8, sampler=sampler, collate_fn=unsupervised_collate_fn)
