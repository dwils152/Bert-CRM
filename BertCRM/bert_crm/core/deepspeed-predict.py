...
def main(args):
    ...
    # Load test indices and reconstruct test subset
    test_indices = torch.load(args.test_indices_path)
    test_subset = torch.utils.data.Subset(hf_dataset, test_indices)
    print(f"Loaded test subset with {len(test_subset)} samples.")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_indices_path', type=str, default='test_indices.pt',
                        help='Path to the saved test indices file.')
